...
This script allows bootstrapping a new CESS chain with the current state of a live chain. Using this, you can create a fork of CESS chain for development purposes.
...
1. Clone this repository and install dependencies
    ...
    ```bash
    git clone https://github.com/CESSProject/cess-hardfork.git
    cd cess-hardfork
    npm i
    ```

2. Create a folder called `data` inside the top folder (`cess-hardfork`).
...
This script is inspired by [fork-off-substrate](https://github.com/maxsam4/fork-off-substrate)
